...
// Rota de teste de erro personalizada
...
router.get('/', (req, res) => {
    ...
    if (categoriaId) {
        ...
        const produtosFiltrados = db.produtos1.filter(
...
router.get('/:id', (req, res) => {
    ...
    const produto = db.produtos1.find(
        p => p.id === produtoId
    );
...
router.delete('/:id', (req, res) => {
    ...
    db.produtos1 = db.produtos1.filter(
        p => p.id !== produtoId
    );
